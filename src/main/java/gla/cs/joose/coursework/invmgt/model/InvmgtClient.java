...
public class InvmgtClient {
	...
	/**
	 * This method makes a REST API call to invmgtapi service for an update to
	 ...
	 * @param newSupplier
	 * @param newDesc
	 * @return returns the updated item if updateRequest is successful or the
	 *         error status code if unsuccessful
	 */
	public Object updateRequest(long updateitemid, long newBarcode, String newItemName, String newItemType_s,
		...
		Object item = putResponse.readEntity(Item.class);
		return item;
	}

	/**
	 * This method makes a REST API call to invmgtapi service to delete an item
	 * from the inventory.
	 * 
	 * @param itemid
	...
	public int deleteRequest(long itemid) {
		Builder builder = itemTarget.resolveTemplate("itemid", itemid).request();
		Response deleteResponse = builder.delete();
		return deleteResponse.getStatus();
	}

	/**
	 * This method makes a REST API call to invmgtapi service to retrieve items
	 * that matches a specific search pattern from the inventory.
	 * 
	 * @param searchbydesc
	 * @param pattern
	 * @param limit
	...
	/**
	 * This method makes a REST API call to invmgtapi service to add an item to
	 * the inventory
	 * 
	 * @param barcode
	 * @param itemName
	 ...
	 * @param supplier
	 * @param desc
	 * @return - returns a REST response status code indicating the outcome of
	 *         addItemRequest
	 */
